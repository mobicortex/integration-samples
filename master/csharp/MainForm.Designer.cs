namespace SmartSdk
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTituloDemos.Text = "API Integration Examples";
            // 
            // btnCadastroCompleto
            // 
            ...
            btnCadastroCompleto.Text = "Full Registry (MobiCortex)";
            ...
            lblDescCompleto.Text = "3-level hierarchical model: Central Registry → Entity (person/vehicle) → Access Media. Ideal for condominiums and companies.";
            // 
            // btnCadastroSimples
            // 
            ...
            btnCadastroSimples.Text = "Simplified Registry";
            ...
            lblDescSimples.Text = "Simplified 2-level model: Person/Vehicle → Media. IDs automatically generated by the controller (createid=true).";
            // 
            // btnMonitoramento
            // 
            ...
            btnMonitoramento.Text = "Monitoring (MQTT)";
            ...
            lblDescMonitoramento.Text = "Receives real-time events via MQTT over WebSocket. Monitors access, sensors and controller status.";
            // 
            // btnDashboard
            // 
            ...
            btnDashboard.Text = "Dashboard / Device Info";
            ...
            lblDescDashboard.Text = "Displays controller information: model, firmware, CPU, memory, registry and media statistics.";
            // 
            // btnMqttCliente
            // 
            ...
            btnMqttCliente.Text = "MQTT Client → Controller";
            ...
            lblDescMqttCliente.Text = "Connects as MQTT client to the controller broker. Receives real-time events via WebSocket.";
            // 
            // btnMqttBroker
            // 
            ...
            btnMqttBroker.Text = "MQTT Broker (Embedded)";
            ...
            lblDescMqttBroker.Text = "Starts an embedded MQTT broker. The controller can connect directly to this server.";
            // 
            // btnWebhookServer
            // 
