...
namespace SmartSdk
{
    ...
    public partial class FormCadastroVeiculo : Form
    {
        ...
        private void SetupFallbackCatalogs()
        {
        ...
        private void ConfigureEditMode()
        {
            ...
            // Increase the maximum to accept high IDs (web range >= 4294000000)
            ...
            // LPR
            _chkLpr.Checked = _entidadeExistente.LprActive;
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Plate is required.", "Validation",
            ...
            if (IdVeiculo == 0)
            {
                var result = MessageBox.Show(
                    "ID not provided. The code will be generated automatically by the controller.\n\nDo you want to continue?",
