...
namespace SmartSdk
{
    ...
    public partial class FormWebhookServer : Form
    {
        ...
        private void ShowSelectedWebhook()
        {
            ...
            var webhook = gridWebhooks.SelectedRows[0].Tag as WebhookReceivedEventArgs;
            ...
            {
                dlg.Text = $"Webhook {webhook.ReceivedAt:HH:mm:ss}  {webhook.RemoteIp}";
                dlg.StartPosition = FormStartPosition.CenterParent;
                dlg.Size = new Size(780, 580);
                dlg.MinimumSize = new Size(480, 320);
